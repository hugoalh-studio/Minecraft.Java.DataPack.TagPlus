...
# <div align="center"><img src="https://i.imgur.com/s4ms8Qv.png" style="height: 64px; width: auto" /><br />Minecraft Java資料包：標籤＋</div>
...
- `stone_brick_walls`
- `stone_bricks`
- `stripped_acacia_logs`
- `stripped_birch_logs`
- `stripped_dark_oak_logs`
- `stripped_jungle_logs`
- `stripped_logs`
- `stripped_oak_logs`
- `stripped_spruce_logs`
- `tall_flowers`
- `terracotta`
- `the_nether_ores`
- `trapdoors`
- `tulips`
- `unstripped_acacia_logs`
- `unstripped_birch_logs`
- `unstripped_dark_oak_logs`
- `unstripped_jungle_logs`
- `unstripped_logs`
- `unstripped_oak_logs`
- `unstripped_spruce_logs`
- `wall_banners`
- `wall_corals`
- `wall_signs`
- `walls`
